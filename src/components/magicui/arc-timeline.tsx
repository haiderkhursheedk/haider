                    ...
                    >
                      <div
                        className={cn(
                          ...
                          isActive
                            ? "bg-[var(--step-line-active-color,#000000)] dark:bg-[var(--step-line-active-color,#000000)]"
                            : "bg-[var(--step-line-inactive-color,#000000)] dark:bg-[var(--step-line-inactive-color,#000000)]",
                        )}
                        style={{
                      ...
                      >
                        <div
                          className={cn(
                            ...
                            isActive
                              ? "translate-y-[calc(100%_+_14px)] scale-[1.2] text-[var(--icon-active-color,#000000)] dark:text-[var(--icon-active-color,#000000)]"
                              : "translate-y-[calc(100%_+_4px)] scale-100 text-[var(--icon-inactive-color,#000000)] dark:text-[var(--icon-inactive-color,#000000)]",
                          )}
                        >
                          {step.icon}
                        </div>
                        <p
                          className={cn(
                            ...
                            "text-[var(--description-color,#000000)] dark:text-[var(--description-color,#000000)]",
                      ...
                      {stepIndex === 0 && (
                        <div
                          className={cn(
                            ...
                            isActive
                              ? "text-[var(--time-active-color,#000000)] dark:text-[var(--time-active-color,#000000)]"
                              : "text-[var(--time-inactive-color,#000000)] dark:text-[var(--time-inactive-color,#000000)]",
                          )}
                        >
                          {line.time}
                        </div>
      ...
      {Array(
        ...
        .map((_, fillIndex) => {
          ...
          return (
            ...
            >
              <div
                className="h-full w-full bg-[var(--placeholder-line-color,#000000)] dark:bg-[var(--placeholder-line-color,#000000)]"
                style={{
                  transformOrigin: "center top",
                  transform: `rotate(${
